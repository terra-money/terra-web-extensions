...
import { ErrorBoundary } from 'frame/components/common/ErrorBoundary';
import { LocalesProvider, useIntlProps } from 'frame/contexts/locales';
import { StoreProvider } from 'frame/contexts/store';
import {
  STATION_CONSTANTS,
