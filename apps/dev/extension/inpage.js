...
(() => {
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("../node_modules/rxjs/_esm5/internal/Observable.js");
/* harmony import */ var _models_message__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/extension/models/message.ts");
...
async function init() {
  ...
  const connectId = meta === null || meta === void 0 ? void 0 : meta.getAttribute('content');

  if (!connectId) {
    throw new Error(`cannot find head > meta[name="terra-connect"]`);
  }

  window.subscribeExtensionState = function () {
    return new rxjs__WEBPACK_IMPORTED_MODULE_1__.Observable(function (subscriber) {
      window.addEventListener('message', function (event) {
        if (!(0,_models_message__WEBPACK_IMPORTED_MODULE_0__.isTerraConnectMessage)(event.data) || event.data.type !== _models_message__WEBPACK_IMPORTED_MODULE_0__.MessageType.EXTENSION_STATE_UPDATED) {
          return;
        }
